...
from ui.tab_local_extraction import TabLocalExtraction
...
class AppState:
    def __init__(self):
        ...
        self.bpu_path = None
        self.bpu_sheet_name = None
        self.bpu_header_row = 1
        self.bpu_column_overrides = None
        self.bpu_code_pattern = None
...
class AppWindow(ctk.CTk):
    def __init__(self):
        ...
        # sous-classe de ctk.CTk / tkinter.Tk (collision avec la methode
        # native self.state() -> TypeError au mainloop()).
        self.app_state = AppState()

        self.tabview = ctk.CTkTabview(self, width=1230, height=790)
        self.tabview.pack(fill="both", expand=True, padx=10, pady=10)

        self.tab_ingest = self.tabview.add("1. Ingestion")
        self.tab_llm = self.tabview.add("2. Prompts LLM")
        self.tab_local = self.tabview.add("2bis. Extraction locale")
        ...
        self.view_local = TabLocalExtraction(self.tab_local, self.app_state, self)
        self.view_local.pack(fill="both", expand=True)
